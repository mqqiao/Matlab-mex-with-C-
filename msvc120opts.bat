...
rem    using the Microsoft Visual C++ compiler version 12.0
rem
rem    $Revision: 1.1.6.1 $  $Date: 2012/09/25 18:20:03 $
rem    Copyright 2007-2012 The MathWorks, Inc.
rem
rem StorageVersion: 1.0
rem C++keyFileName: MSVC120OPTS.BAT
rem C++keyName: Microsoft Visual C++ 2013
rem C++keyManufacturer: Microsoft
rem C++keyVersion: 12.0
rem C++keyLanguage: C++
rem C++keyLinkerName: Microsoft Visual C++ 2013
rem C++keyLinkerVer: 12.0
rem
rem ********************************************************************
...
set LIB=%VCINSTALLDIR%\LIB;%VCINSTALLDIR%\ATLMFC\LIB;%LINKERDIR%\lib\winv6.3\um\x86;%MATLAB%\extern\lib\win32;%LIB%
